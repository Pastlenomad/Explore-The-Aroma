...
import type { Options as DevServerOptions } from 'next/dist/server/dev/next-dev-servernext-dev-server';
import type { NextConfigComplete } from 'next/dist/server/config-sharedr/config-shared';
import type { IncomingMessage, ServerResponse } from 'http';
import type { NextUrlWithParsedQuery } from 'next/dist/server/request-metaer/request-meta';
...
import { default as Server } from 'next/dist/server/next-serverver/next-server';
