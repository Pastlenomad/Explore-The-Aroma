...
import type { Header, Redirect, Rewrite } from 'next/dist/lib/load-custom-routes-routes';
import { ImageConfig, ImageConfigComplete } from 'next/dist/shared/lib/image-config-config';
import { SubresourceIntegrityAlgorithm } from 'next/dist/build/webpack/plugins/subresource-integrity-plugin-plugin';
import { WEB_VITALS } from 'next/dist/shared/lib/utilsb/utils';
import type { NextParsedUrlQuery } from 'next/dist/server/request-metaer/request-meta';
