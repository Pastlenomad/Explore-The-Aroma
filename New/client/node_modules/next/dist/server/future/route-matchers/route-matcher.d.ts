import type { RouteMatch } from 'next/dist/server/future/route-matches/route-matche-matches/route-match';
import type { RouteDefinition } from 'next/dist/server/future/route-definitions/route-definitionions/route-definition';
