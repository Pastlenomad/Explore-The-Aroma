...
import type { CustomRoutes } from 'next/dist/lib/load-custom-routes-routes';
import type { DomainLocale } from 'next/dist/server/configt/server/config';
import type { RouterOptions } from 'next/dist/server/routert/server/router';
import type { FontManifest, FontConfig } from 'next/dist/server/font-utilsrver/font-utils';
import type { LoadComponentsReturnType } from 'next/dist/server/load-componentsload-components';
import type { RouteMatchFn } from 'next/dist/shared/lib/router/utils/route-matchermatcher';
import type { MiddlewareRouteMatch } from 'next/dist/shared/lib/router/utils/middleware-route-matchermatcher';
import type { Params } from 'next/dist/shared/lib/router/utils/route-matchermatcher';
import type { NextConfig, NextConfigComplete } from 'next/dist/server/config-sharedr/config-shared';
import type { NextParsedUrlQuery, NextUrlWithParsedQuery } from 'next/dist/server/request-metaer/request-meta';
import type { ParsedUrlQuery } from 'querystring';
import type { RenderOpts, RenderOptsPartial } from 'next/dist/server/rendert/server/render';
import type { ResponseCacheBase } from 'next/dist/server/response-cache/response-cache';
...
import type { ClientReferenceManifest } from 'next/dist/build/webpack/plugins/flight-manifest-plugin-plugin';
import type { NextFontManifest } from 'next/dist/build/webpack/plugins/next-font-manifest-plugin-plugin';
import Router from 'next/dist/server/routert/server/router';
import RenderResult from 'next/dist/server/render-resultr/render-result';
import { ImageConfigComplete } from 'next/dist/shared/lib/image-config-config';
import { MiddlewareMatcher } from 'next/dist/build/analysis/get-page-static-infoic-info';
import { RouteMatcherManager } from 'next/dist/server/future/route-matcher-managers/route-matcher-managermatcher-manager';
import { RouteHandlerManager } from 'next/dist/server/future/route-handler-managers/route-handler-managerhandler-manager';
import { LocaleRouteNormalizer } from 'next/dist/server/future/normalizers/locale-route-normalizeroute-normalizer';
import { I18NProvider } from 'next/dist/server/future/helpers/i18n-providers/i18n-provider';
...
export default abstract class Server<ServerOptions extends Options = Options> {
    ...
    }): import('next/dist/server/lib/incremental-cachecremental-cache').IncrementalCache;
    ...
    protected getStaticPaths({ pathname, }: {
        pathname: string;
        requestHeaders: import('next/dist/server/lib/incremental-cachecremental-cache').IncrementalCache['requestHeaders'];
