...
import type { RequestCookies } from 'next/dist/server/web/spec-extension/cookiesserver/web/spec-extension/cookies';
import type { BaseNextResponse } from 'next/dist/server/base-httpase-http';
import type { ServerResponse } from 'http';
import { ResponseCookies } from 'next/dist/server/web/spec-extension/cookiesserver/web/spec-extension/cookies';
