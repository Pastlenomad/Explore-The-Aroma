...
import type { RouteMatchFn, Params } from 'next/dist/shared/lib/router/utils/route-matchermatcher';
import type { RouteHas } from 'next/dist/lib/load-custom-routes-routes';
...
import type { I18NProvider } from 'next/dist/server/future/helpers/i18n-providers/i18n-provider';
type RouteResult = {
    finished: boolean;
    pathname?: string;
