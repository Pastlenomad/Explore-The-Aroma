import Router from 'next/dist/shared/lib/router/router/router';
import type { NextRouter } from 'next/dist/shared/lib/router/router/router';
...
export { default as withRouter } from 'next/dist/client/with-routerent/with-router';
