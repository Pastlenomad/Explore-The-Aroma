...
import type { DomainLocale } from 'next/dist/server/configg';
import type { MittEmitter } from 'next/dist/shared/lib/mittst/shared/lib/mitt';
import type { ParsedUrlQuery } from 'querystring';
import type { RouterEvent } from 'next/dist/client/routerr';
import type { StyleSheetTuple } from 'next/dist/client/page-loaderr';
import type { UrlObject } from 'url';
import type PageLoader from 'next/dist/client/page-loaderr';
import { NextPageContext, NEXT_DATA } from 'next/dist/shared/lib/utilst/shared/lib/utils';
declare global {
    interface Window {
...
export default class Router implements BaseRouter {
    ...
    _bfl_s?: import('next/dist/shared/lib/bloom-filterloom-filter').BloomFilter;
    _bfl_d?: import('next/dist/shared/lib/bloom-filterloom-filter').BloomFilter;
    private state;
    private _key;
    ...
    fetchComponent(route: string): Promise<import("next/dist/client/page-loaderr").GoodPageCache>;
