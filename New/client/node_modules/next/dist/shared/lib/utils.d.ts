...
/// <reference types="node" />
/// <reference types="node" />
import type { HtmlProps } from 'next/dist/shared/lib/html-contexted/lib/html-context';
import type { ComponentType } from 'react';
import type { DomainLocale } from 'next/dist/server/confignfig';
import type { Env } from '@next/env';
import type { IncomingMessage, ServerResponse } from 'http';
import type { NextRouter } from 'next/dist/shared/lib/router/routerd/lib/router/router';
import type { ParsedUrlQuery } from 'querystring';
import type { PreviewData } from 'next/types';
import { COMPILER_NAMES } from 'next/dist/shared/lib/constantshared/lib/constants';
