...
import type { NextConfigComplete } from 'next/dist/server/config-shared-shared';
import type { AppBuildManifest } from 'next/dist/build/webpack/plugins/app-build-manifest-pluginanifest-plugin';
import type { GetStaticPaths, ServerRuntime } from 'next/types';
import type { BuildManifest } from 'next/dist/server/get-page-filese-files';
import type { CustomRoutes } from 'next/dist/lib/load-custom-routes-routes';
import type { UnwrapPromise } from 'next/dist/lib/coalesced-functionunction';
import type { MiddlewareManifest } from 'next/dist/build/webpack/plugins/middleware-plugindleware-plugin';
import 'next/dist/server/require-hookre-hook';
import 'next/dist/server/node-polyfill-fetchl-fetch';
import 'next/dist/server/node-polyfill-crypto-crypto';
import 'next/dist/server/node-environmentronment';
import { IncrementalCache } from 'next/dist/server/lib/incremental-cachel-cache';
import { patchFetch } from 'next/dist/server/lib/patch-fetchh-fetch';
