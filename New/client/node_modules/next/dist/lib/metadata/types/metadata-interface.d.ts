import type { AlternateURLs, ResolvedAlternateURLs } from 'next/dist/lib/metadata/types/alternative-urls-typesypes/alternative-urls-types';
import type { AppleWebApp, AppLinks, FormatDetection, ItunesApp, ResolvedAppleWebApp, ResolvedAppLinks, Viewport } from 'next/dist/lib/metadata/types/extra-types/metadata/types/extra-types';
import type { DeprecatedMetadataFields, AbsoluteTemplateString, Author, ColorSchemeEnum, Icon, Icons, IconURL, ReferrerEnum, ResolvedIcons, ResolvedVerification, Robots, ResolvedRobots, TemplateString, Verification, ThemeColorDescriptor } from 'next/dist/lib/metadata/types/metadata-typestadata/types/metadata-types';
import type { Manifest as ManifestFile } from 'next/dist/lib/metadata/types/manifest-typestadata/types/manifest-types';
import type { OpenGraph, ResolvedOpenGraph } from 'next/dist/lib/metadata/types/opengraph-typesadata/types/opengraph-types';
import type { ResolvedTwitterMetadata, Twitter } from 'next/dist/lib/metadata/types/twitter-typesetadata/types/twitter-types';
/**
