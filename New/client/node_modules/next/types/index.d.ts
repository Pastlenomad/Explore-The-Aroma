...
} from 'next/dist/shared/lib/utilsls'

import {
  NextApiRequestCookies,
  // @ts-ignore This path is generated at build time and conflicts otherwise
} from 'next/dist/server/api-utilsls'

// @ts-ignore This path is generated at build time and conflicts otherwise
import next from 'next/dist/server/nextxt'

export type ServerRuntime = 'nodejs' | 'experimental-edge' | 'edge' | undefined

// @ts-ignore This path is generated at build time and conflicts otherwise
export { NextConfig } from 'next/dist/server/configig'
...
} from 'next/dist/lib/metadata/types/metadata-interfacece'
